...
/** Build one JSONL transcript line (same shape as the analytics test fixtures). */
function line(o: {
  uuid: string;
  ts: number;
  content: unknown[];

...
function ev(over: Partial<FlatEvent>): FlatEvent {
  return {
    uuid: "u", blockIdx: 0, parentUuid: null, sessionId: "s1", project: "alpha",
    cwd: "/c", ts: 1000, kind: "text", tool: null, command: null, corr: null,
    isError: null, inputJson: null, result: null, stderr: null, diff: null,
    resultHead: null, text: null, durMs: null, gitBranch: null, raw: "{}", ...over,
  };
}
...
beforeEach(() => {
  ...
  w.add([
    ...
    ev({ uuid: "a", blockIdx: 1, kind: "tool_result", isError: true, result: "x", corr: "t1" }),

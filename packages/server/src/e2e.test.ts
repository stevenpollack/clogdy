...
beforeAll(async () => {
  ...
  writeFileSync(
    join(d1, `${S1}.jsonl`),
    [
      J({ uuid: "s1l1", parentUuid: null, sessionId: S1, cwd: "/home/me/proj-one", timestamp: "2024-03-01T00:00:00.000Z", message: { role: "user", content: "first task" } }),
      J({ uuid: "s1l2", parentUuid: "s1l1", sessionId: S1, cwd: "/home/me/proj-one", timestamp: "2024-03-01T00:00:01.000Z", message: { role: "assistant", content: [{ type: "tool_use", id: "c1", name: "Bash", input: { command: "ls" } }] } }),
      J({ uuid: "s1l3", parentUuid: "s1l2", sessionId: S1, cwd: "/home/me/proj-one", timestamp: "2024-03-01T00:00:02.000Z", toolUseResult: { stdout: "a\nb", stderr: "" }, message: { role: "user", content: [{ type: "tool_result", tool_use_id: "c1", is_error: false, content: "a\nb" }] } }),
    ].join("\n") + "\n",
  );
  ...
  writeFileSync(
    join(d2, `${S2}.jsonl`),
    [
      J({ uuid: "s2l1", parentUuid: null, sessionId: S2, cwd: "/home/me/proj-one", timestamp: "2024-03-02T00:00:00.000Z", message: { role: "assistant", content: [{ type: "text", text: "let me check" }] } }),
      J({ uuid: "s2l2", parentUuid: "s2l1", sessionId: S2, cwd: "/home/me/proj-one", timestamp: "2024-03-02T00:00:01.000Z", message: { role: "assistant", content: [{ type: "tool_use", id: "c2", name: "Bash", input: { command: "false" } }] } }),
      J({ uuid: "s2l3", parentUuid: "s2l2", sessionId: S2, cwd: "/home/me/proj-one", timestamp: "2024-03-02T00:00:02.000Z", toolUseResult: { stdout: "", stderr: "boom" }, message: { role: "user", content: [{ type: "tool_result", tool_use_id: "c2", is_error: true, content: "exit 1" }] } }),
    ].join("\n") + "\n",
  );
  ...
  writeFileSync(
    join(d3, `${S3}.jsonl`),
    [
      J({ uuid: "s3l1", parentUuid: null, sessionId: S3, cwd: "/home/me/proj-two", timestamp: "2024-03-03T00:00:00.000Z", message: { role: "user", content: "fetch it" } }),
      J({ uuid: "s3l2", parentUuid: "s3l1", sessionId: S3, cwd: "/home/me/proj-two", timestamp: "2024-03-03T00:00:01.000Z", message: { role: "assistant", content: [{ type: "tool_use", id: "c3", name: "WebFetch", input: { url: "http://x" } }] } }),
      J({ uuid: "s3l3", parentUuid: "s3l2", sessionId: S3, cwd: "/home/me/proj-two", timestamp: "2024-03-03T00:00:02.000Z", toolUseResult: { url: "http://x", bytes: 2048, code: 200, durationMs: 350 }, message: { role: "user", content: [{ type: "tool_result", tool_use_id: "c3", is_error: false, content: "<html>" }] } }),
      J({ type: "summary", uuid: "s3l4", sessionId: S3, cwd: "/home/me/proj-two", timestamp: "2024-03-03T00:00:03.000Z", summary: "noise" }),
    ].join("\n") + "\n",
  );
